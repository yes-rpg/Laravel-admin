...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat 1px 0;
        }

        .login-main .login-bottom .center .item .icon-2 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat -54px 0;
        }

        .login-main .login-bottom .center .item .icon-3 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat -106px 0;
        }

        .login-main .login-bottom .center .item .icon-4 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat 0 -43px;
            position: absolute;
            right: -10px;
            cursor: pointer;
        }
        ...
        .login-main .login-bottom .center .item .icon-5 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat -55px -43px;
        }

        .login-main .login-bottom .center .item .icon-6 {
            background: url("{{ asset('static/admin/images/icon-login.png') }}") no-repeat 0 -93px;
            position: absolute;
            right: -10px;
            margin-top: 8px;
            cursor: pointer;
        ...
        .login-main .login-bottom .tip .icon-check {
            ...
            height: 14px;
            border: none;
            background: url({{ asset('static/admin/images/icon-login.png') }}) no-repeat -111px -48px;
        }
        ...
        body {
            background: url("{{ asset('static/admin/images/loginbg.png') }}") 0% 0% / cover no-repeat;
            position: static;
            font-size: 12px;
        }
...
<div class="main-body">
    <div class="login-main">
        ...
        <form class="layui-form login-bottom" method="post" action="{{ route('admin.login') }}">
            {{ csrf_field() }}
            <div class="center">
                <div class="item">
                ...
                <div id="validatePanel" class="item" style="width: 137px;">
                    <input type="text" name="captcha" placeholder="请输入验证码" id="captcha" maxlength="10">
                    <img id="refreshCaptcha" class="validateImg" src="{{ captcha_src('admin.login') }}"
            ...
            <div class="layui-form-item" style="text-align:center; width:100%;height:100%;margin:0px;">
                <button class="login-btn" type="button" lay-submit="" lay-filter="login" id="login-btn">立即登录</button>
            </div>
        </form>
    </div>
</div>
